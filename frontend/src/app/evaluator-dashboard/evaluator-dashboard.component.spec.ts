...
describe('EvaluatorDashboardComponent', () => {
  ...
  const queue: EvaluationQueueItem[] = [
    { id: 'i1', code: 'IDEA-0001', titleAr: 'ا', titleEn: 'Alpha', strategicThemeId: 't1', updatedAt: '2026-07-01T00:00:00Z' },
    { id: 'i2', code: 'IDEA-0002', titleAr: 'ب', titleEn: 'Beta', strategicThemeId: 't1', updatedAt: '2026-07-02T00:00:00Z' },
  ];
