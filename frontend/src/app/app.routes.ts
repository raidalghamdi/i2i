...
import { ideaAuthorGuard } from './core/auth/guards/idea-author-guard';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'supervisor/evaluation-review',
        loadComponent: () =>
          import('./supervisor/evaluation-review-queue/evaluation-review-queue.component').then(
            (m) => m.EvaluationReviewQueueComponent,
          ),
        canActivate: [supervisorOrAdminGuard],
      },
      {
        path: 'supervisor/evaluation-review/:id',
        loadComponent: () =>
          import('./supervisor/evaluation-review/evaluation-review-form.component').then(
            (m) => m.EvaluationReviewFormComponent,
          ),
        canActivate: [supervisorOrAdminGuard],
      },
      {
        path: 'supervisor/committee-pending',
        loadComponent: () =>
          import('./supervisor/committee-pending-queue/committee-pending-queue.component').then(
            (m) => m.CommitteePendingQueueComponent,
          ),
        canActivate: [supervisorOrAdminGuard],
      },
      {
        path: 'supervisor/submit-to-committee/:id',
        loadComponent: () =>
          import('./supervisor/submit-to-committee/submit-to-committee-form.component').then(
            (m) => m.SubmitToCommitteeFormComponent,
          ),
        canActivate: [supervisorOrAdminGuard],
      },
      {
      ...
      {
        path: 'admin/idea-template',
        loadComponent: () =>
          import('./admin/idea-template/idea-template.component').then(
            (m) => m.IdeaTemplateComponent,
          ),
        canActivate: [adminOnlyGuard],
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./admin/home-builder/home-builder.component').then((m) => m.HomeBuilderComponent),
        canActivate: [adminOnlyGuard],
      },
    ],
  },
