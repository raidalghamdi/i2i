...
describe('SupervisorDashboardComponent', () => {
  ...
  it('renders links to the screening queue, track assignments, evaluation review, and committee-pending queues', () => {
    setup();
    ...
    expect(links.some((a) => a.getAttribute('href') === '/supervisor/evaluation-review')).toBe(true);
    expect(links.some((a) => a.getAttribute('href') === '/supervisor/committee-pending')).toBe(true);
  });
