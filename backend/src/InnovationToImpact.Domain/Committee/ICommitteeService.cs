...
public interface ICommitteeService
{
    ...
    Task<CommitteeAttachmentFileResult> GetDecisionAttachmentFileAsync(Guid decisionId, Guid attachmentId, CancellationToken cancellationToken = default); // Change 20260726
}
