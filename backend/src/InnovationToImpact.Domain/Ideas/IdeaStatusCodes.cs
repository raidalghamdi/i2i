...
public static class IdeaStatusCodes
{
    ...
    public const string EvaluationReview = "evaluation_review";
    public const string SubmitterReview = "submitter_review";
    public const string CommitteePending = "committee_pending";
