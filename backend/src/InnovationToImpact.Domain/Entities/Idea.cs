...
public class Idea
{
    ...
    public decimal? EvaluationAggregateScore { get; set; }
    public string? EvaluationAggregateJson { get; set; }
    public string? SupervisorEvaluationComment { get; set; }
    public string? SubmitterResubmitComment { get; set; }
