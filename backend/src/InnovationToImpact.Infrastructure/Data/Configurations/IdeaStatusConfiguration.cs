...
public class IdeaStatusConfiguration : IEntityTypeConfiguration<IdeaStatus>
{
    private static readonly (string Code, string NameAr, string NameEn)[] SeedStatuses =
    {
        ...
        ("evaluation_review", "مراجعة المشرف للتقييم", "Supervisor Evaluation Review"),
        ("submitter_review", "مراجعة مقدّم الفكرة", "Submitter Review"),
        ("committee_pending", "بانتظار الإحالة للجنة", "Awaiting Committee Referral"),
    };
