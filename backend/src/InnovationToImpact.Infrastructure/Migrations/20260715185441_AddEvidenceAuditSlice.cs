...
{
    /// <inheritdoc />
    public partial class AddEvidenceAuditSlice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChainSeq = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvidenceAttachments_Users_UploaderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ChainSeq",
                table: "AuditLogs",
                column: "ChainSeq",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EvidenceAttachments_UploaderId",
