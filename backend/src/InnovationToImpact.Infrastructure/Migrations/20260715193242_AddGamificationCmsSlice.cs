...
{
    /// <inheritdoc />
    public partial class AddGamificationCmsSlice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsBlocks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportTitles", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CmsBlocks_Key",
                table: "CmsBlocks",
                column: "Key",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReportTitles_Key",
                table: "ReportTitles",
                column: "Key",
                unique: true);
